                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="ruangan" class="form-label fw-semibold">
                                                <i class="fas fa-map-marker-alt text-info me-2"></i>Ruangan
                                                <span class="text-danger">*</span>
                                            </label>
                                            <select name="ruangan" id="ruangan"
                                                class="form-control form-control-lg @error('ruangan') is-invalid @enderror" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="description" class="form-label fw-semibold">
                                                <i class="fas fa-align-left text-warning me-2"></i>Deskripsi Masalah
                                                <span class="text-danger">*</span>
                                            </label>
                                            <textarea name="description" id="description" rows="5"
                                                class="form-control form-control-lg @error('description') is-invalid @enderror"
                                                required placeholder="Jelaskan masalah yang Anda alami secara detail...">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group upload-area">
                                            ...
                                            <div class="form-text">
                                                ...
                                                Upload foto yang menunjukkan masalah IT yang Anda alami. Maksimal 2MB.
                                            </div>
