    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden shadow rounded-lg bg-white dark:bg-gray-800 p-4">
            ...
            <table class="table-auto w-full min-w-[640px] border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 dark:border-gray-700 px-4 py-2 font-bold text-gray-800 dark:text-gray-200">{{ $reform['summary']['total_bobot'] }}</td>
                        <td class="border border-gray-200 dark:border-gray-700 px-4 py-2 font-bold text-gray-800 dark:text-gray-200">{{ $reform['summary']['total_nilai_unit'] }}</td>
                        <td class="border border-gray-200 dark:border-gray-700 px-4 py-2 font-bold text-gray-800 dark:text-gray-200">{{ $reform['summary']['total_nilai_tpi'] }}</td>
                    </tr>
                </tbody>
            </table>
            </div>
