            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    @else
                        ...
                        <!-- Profile Dropdown -->
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle mr-3 text-dark" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-user-circle"></i> {{ Auth::user()->name }}
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('welcome') }}"
                                    class="dropdown-item {{ request()->routeIs('welcome') ? 'active' : '' }}">
                                    <i class="fas fa-home"></i> Home
                                </a>
                                ...
                                <a href="{{ route('user.dashboard') }}"
                                    class="dropdown-item {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
                                    <i class="fas fa-user"></i> My Dashboard
                                </a>
                                <a href="{{ route(auth()->user()->is_admin ? 'admin.tasks.index' : 'user.tasks.index') }}"
                                    class="dropdown-item {{ request()->routeIs(['admin.tasks.index', 'user.tasks.index']) ? 'active' : '' }}">
                                    <i class="fas fa-tasks"></i> Tasks
                                </a>
    ...
    <footer>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <h5>Follow Us</h5>
                        <ul class="list-unstyled">
                            <li><a href="https://www.facebook.com/BPS.KOTA.BATAM/?locale=id_ID"><i
                                        class="fab fa-facebook"></i> Facebook</a></li>
                            <li><a href="https://www.instagram.com/bps.batam/"><i class="fab fa-instagram"></i>
                                    Instagram</a></li>
                            <li><a href="https://www.youtube.com/channel/UCjNSyjtj4Y9fBhxcJG3Xaag"><i
        ...
        <div class="footer-bottom">
            <div class="container text-center">
                <p>&copy; 2024 BPS Kota Batam | <a href="https://batamkota.bps.go.id/"
                        class="text-white">batamkota.bps.go.id</a></p>
            </div>
        </div>
    </footer>
