            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Masuk (Laksamana)</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('laksamana.login.post') }}">
                            @csrf
                            <div class="mb-3">
                        ...
                        <hr>
                        <p class="mb-0">Belum punya akun? <a href="{{ route('laksamana.register') }}">Daftar di sini</a>.</p>
                    </div>
                </div>
            </div>
        </div>
